...
| **Tests** | **25/25 pass** on the v2.4.0 Homer infrastructure: `test_cost_guard.py` 3/3 + `test_token_accountant.py` 22/22. Reproduce: `python plugins/godspeed/automations/homer/test_cost_guard.py && python plugins/godspeed/automations/homer/token_accountant/test_token_accountant.py`. |
