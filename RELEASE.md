...
# Verify zero personal leaks (should return nothing)
grep -rn "jbro1\|Ribbz\|the user wants\|Desktop/T1" plugins/ toke/ README.md install.sh install.ps1 LICENSE 2>/dev/null | grep -v __pycache__
